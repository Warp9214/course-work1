...
<body>
<div class="container">
    <h1 class="hh">Сторінка Студента</h1>
    ...
    <% } %>
    <div class="top-links">
    <a href="${pageContext.request.contextPath}/index.jsp" class="top-link">Перейти на головну сторінку</a>
    <a href="${pageContext.request.contextPath}/admin" class="top-link">Перейти до Панелі Деканату</a>
    </div>
