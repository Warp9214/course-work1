...
<body>
<div class="container">
    <h1 class="hh">Панель Деканату</h1>
    ...
    <div class="top-links">
        <a href="${pageContext.request.contextPath}/index.jsp" class="top-link">Головна сторінка</a>
        <a href="${pageContext.request.contextPath}/student" class="top-link">Студентська Панель</a>
    </div>
